...
Uri uri = 
Uri.parse("android.resource://com.example.newlyindependent/"+R.raw.aloosandwich); videoView.setVideoURI(uri); 
...
Intent mi = new 
Intent(getApplicationContext(),PlanMealActivity.class); 
