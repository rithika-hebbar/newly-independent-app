    ...
    btnrec.setOnClickListener(new View.OnClickListener() { 
        ...
        public void onClick(View arg0) { 
            ...
            if(searchname.equals("Rava Dosa")){ 
                ...
                Intent ri = new Intent(getApplicationContext(), RasamActivity.class); 
                ri.putExtra("name", name); 
                startActivity(ri);
            }else if(searchname.equals("Chapati")){ 
                Intent ri = new Intent(getApplicationContext(), ChapatiActivity.class); 
                ri.putExtra("name", name); 
                startActivity(ri); 
            }else if(searchname.equals("Upma")){ 
                Intent ri = new Intent(getApplicationContext(), UpmaActivity.class); 
                ri.putExtra("name", name); 
                startActivity(ri); 
            }else{} 
        } 
