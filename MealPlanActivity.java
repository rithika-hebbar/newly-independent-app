...
public class MealPlanActivity extends Activity{ 
    ...
    public void populateListView(){ 
        ...
        SimpleCursorAdapter ca = new SimpleCursorAdapter(this, R.layout.layout_listview, result, fields, viewid); ListView lv = (ListView)findViewById(R.id.listView1); 
lv.setAdapter(ca); 
} 
...
Intent lvi = new Intent(getApplicationContext(), 
