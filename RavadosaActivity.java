...
public class RavadosaActivity extends Activity{ 
TextView itemname; 
Button mealplan; 
ProgressBar time; 
RatingBar ease; 
...
setContentView(R.layout.activity_ravadosa); 
Intent i = getIntent(); 
name = i.getExtras().getString("name"); 
VideoView videoView = (VideoView) findViewById(R.id.videoView1); 
Uri uri = 
Uri.parse("android.resource://com.example.newlyindependent/"+R.raw.ravadosavid); videoView.setVideoURI(uri); 
MediaController mediaController = new MediaController(this); 
videoView.setMediaController(mediaController); 
mediaController.setAnchorView(videoView);
time = (ProgressBar)findViewById(R.id.progressBar1); time.setMax(10); 
time.setProgress(5); 
